...
class Sales_Order_Form(forms.Form):
    ...
    so_type_grade1 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    so_size1 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_length1 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity1 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade2 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    size2 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length2 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity2 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade2 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    so_size2 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_length2 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity2 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade3 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    size3 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length3 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity3 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade3 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    so_size3 = forms.ChoiceField(choices=size_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_length3 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity3 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade4 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    size4 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length4 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity4 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade4 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    so_size4 = forms.ChoiceField(choices=size_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_length4 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity4 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade5 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    size5 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length5 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity5 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade5 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    so_size5 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_length5 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity5 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade6 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    size6 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length6 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity6 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade6 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    so_size6 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_length6 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity6 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade7 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    size7 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length7 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity7 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade7 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    so_size7 = forms.ChoiceField(choices=size_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_length7 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity7 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade8 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    size8 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length8 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity8 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade8 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    so_size8 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_length8 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity8 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade9 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    size9 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length9 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity9 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade9 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    so_size9 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_length9 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity9 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade10 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    size10 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length10 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity10 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade10 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    so_size10 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_length10 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity10 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade11 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    size11 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length11 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity11 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade11 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    so_size11 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_length11 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity11 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade12 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    size12 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length12 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity12 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade12 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    so_size12 = forms.ChoiceField(choices=size_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_length12 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity12 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade13 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    size13 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length13 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity13 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade13 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    so_size13 = forms.ChoiceField(choices=size_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_length13 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity13 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade14 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    size14 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length14 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity14 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade14 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    so_size14 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_length14 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity14 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade15 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    size15 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length15 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity15 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade15 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    so_size15 = forms.ChoiceField(choices=size_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_length15 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity15 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade16 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    size16 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length16 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity16 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade16 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    so_size16 = forms.ChoiceField(choices=size_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_length16 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity16 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade17 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    size17 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length17 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity17 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade17 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    so_size17 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_length17 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity17 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade18 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    size18 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length18 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity18 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade18 = forms.ChoiceField( choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    so_size18 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_length18 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity18 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade19 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    size19 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length19 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity19 = forms.IntegerField(initial=0, min_value=0, widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade19 = forms.ChoiceField( choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    so_size19 = forms.ChoiceField(choices=size_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_length19 = forms.ChoiceField(choices=length_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity19 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    type_grade20 = forms.ChoiceField(choices=type_grade_choice,widget=forms.Select(attrs={'class': 'form-control'}))
    size20 = forms.ChoiceField(choices=size_choices, widget=forms.Select(attrs={'class': 'form-control'}))
    length20 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    order_quantity20 = forms.IntegerField( initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))

    so_type_grade20 = forms.ChoiceField(choices=type_grade_choice, widget=forms.Select(attrs={'class': 'form-control'}))
    so_size20 = forms.ChoiceField(choices=size_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_length20 = forms.ChoiceField(choices=length_choices,widget=forms.Select(attrs={'class': 'form-control'}))
    so_order_quantity20 = forms.IntegerField(initial=0, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control'}))
